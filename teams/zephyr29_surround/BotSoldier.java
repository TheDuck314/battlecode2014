		...
		switch (rallyGoal) {
			case GATHER:
				if (rallyLoc.equals(theirHQ)) {
					if (!isInTheirHQAttackRange(here) && isInTheirHQAttackRange(here.add(here.directionTo(theirHQ)))) {
						return true;
					}
					return false;
				}
				System.out.println("RALLY LOC ISN'T ENEMY HQ!!!!");
				return false;
