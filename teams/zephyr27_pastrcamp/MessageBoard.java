...
public enum MessageBoard {
	...
	SUPPRESSOR_TARGET_LOCATIONS(GameConstants.BROADCAST_MAX_CHANNELS - 70),
	SUPPRESSOR_BUILDER_ROBOT_IDS(GameConstants.BROADCAST_MAX_CHANNELS - 80),
	SUPPRESSOR_JOBS_FINISHED(GameConstants.BROADCAST_MAX_CHANNELS - 90);
