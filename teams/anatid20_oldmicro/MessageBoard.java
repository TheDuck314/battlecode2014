...
public enum MessageBoard {
	...
	PASTR_DISTRESS_SIGNAL(GameConstants.BROADCAST_MAX_CHANNELS - 7),
	SELF_DESTRUCT_LOCKOUT_ID(GameConstants.BROADCAST_MAX_CHANNELS - 8),
	SELF_DESTRUCT_LOCKOUT_ROUND(GameConstants.BROADCAST_MAX_CHANNELS - 9),
