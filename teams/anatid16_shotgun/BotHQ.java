...
public class BotHQ extends Bot {
	...
	private void doFirstTurn() throws GameActionException {
		...
		MessageBoard.SHOTGUN_PASTR_LOCATIONS.writeShotgunPastrLocation(0, new MapLocation(40, 8));
		MessageBoard.SHOTGUN_PASTR_LOCATIONS.writeShotgunPastrLocation(1, new MapLocation(40, 30));
		MessageBoard.SHOTGUN_PASTR_LOCATIONS.writeShotgunPastrLocation(2, new MapLocation(40, 48));
		MessageBoard.SHOTGUN_PASTR_LOCATIONS.writeShotgunPastrLocation(3, new MapLocation(40, 70));
		
		// Strategy.active = pickStrategyByAnalyzingMap();
		Strategy.active = Strategy.SHOTGUN;
	...
	private void directStrategyShotgun() {
