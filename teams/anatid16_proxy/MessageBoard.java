...
public enum MessageBoard {
	...
	PASTR_BUILDER_SPAWN_ORDER(GameConstants.BROADCAST_MAX_CHANNELS - 10),
	TOWER_BUILDER_SPAWN_ORDER(GameConstants.BROADCAST_MAX_CHANNELS - 11),
	PASTR_BUILDER_ROBOT_ID(GameConstants.BROADCAST_MAX_CHANNELS - 12),
	TOWER_BUILDER_ROBOT_ID(GameConstants.BROADCAST_MAX_CHANNELS - 13);
	...
	public static void setDefaultChannelValues() throws GameActionException {
		...
		PASTR_BUILDER_SPAWN_ORDER.writeInt(-1);
		TOWER_BUILDER_SPAWN_ORDER.writeInt(-1);
		PASTR_BUILDER_ROBOT_ID.writeInt(-1);
		TOWER_BUILDER_ROBOT_ID.writeInt(-1);
	}
